...
export const LoadingScreen: React.FC<LoadingScreenProps> = ({
  ...
  return (
    <div
      ...
      } flex flex-col items-center justify-center transition-opacity duration-500 ease-out`}
    ...
    >
      <div className="relative flex flex-col items-center animate-loaderFade">
        ...
        <div className="loader-logo-card relative w-28 h-28 rounded-full p-4 flex items-center justify-center">
