  ...
  return createPortal(
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <span className="font-bold text-sm leading-snug">
          ...
          {type === 'warning' && isOverrideable && (
            <span className="underline ml-1.5 opacity-90">(Click Next again to override)</span>
          )}
        </span>
      </div>
      ...
      <button
        ...
        className="p-1 rounded-lg hover:bg-black/10 dark:hover:bg-white/10 transition-colors ml-2 flex-shrink-0"
